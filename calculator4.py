...
cells = {"locked": [], "present_but_not_locked": [], "not_present": []}
...
def get_letter_config():
    ...
    containing = ""
    for c in cells["present_but_not_locked"]:
        if 'pressed' in c.classList:
